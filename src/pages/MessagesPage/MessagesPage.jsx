  ...
  const MessagesPage = () => {
    ...
    useEffect(() => {
          ...
          setMessages(msgs.map(msg => {
            ...
            return {
              ...
              avatar: msg.sender._id === currentUserId
                ? msg?.sender?.avatar
                : msg?.sender?.avatar || receiverUser?.avatar ,
      ...
      console.log("tyuiop[dfghjkl;sdfghjkl;",messages);
            ...
            {loadingUsers ? (
              ...
              Array.isArray(Personal) && Personal.length === 0 ? (
                ...
                Personal.map((item, index) => (
                  ...
                  >
                    <img
                      src={item?.avatar || "https://cdn-icons-png.flaticon.com/512/6858/6858504.png"}
                      width="40"
                      alt="User"
          ...
          <div className="col-12 col-md-8 col-lg-9 d-flex flex-column">
            {
              id ? <div className="d-flex align-items-center p-3  border-bottom">
                ...
                />
                <div>
                  <span className="ms-3">{receiverUser?.name || "Chat with Host"}</span>
