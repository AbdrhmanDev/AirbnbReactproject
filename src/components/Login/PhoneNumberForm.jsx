                ...
                {!showOtpInputs ? (
                  <>
                    ...
                    <div className={style.googleLoginBox}>
                      <GoogleLogin
                        onSuccess={(response) => handleGoogleLoginSuccess(response, setIsLoggedIn, modalRef, setGoogleCredential ,setUserData)}
                  ...
                  <>
                    ...
                    <button className={style.verifyBtn} onClick={() => handleVerifyOTP(otp, confirmationResult, setIsLoggedIn, setShowOtpInputs, setOtp, modalRef)}>
                      Verify OTP
                    </button>
                  </>
                )}
