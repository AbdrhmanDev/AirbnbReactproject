...
const Navbar = () => {
      ...
      <nav className="navbar navbar-expand-lg bg-white">
        <div className="container d-flex justify-content-between align-items-center ">
          ...
          <div className="d-flex align-items-center gap-3">
            ...
            {isLogin || auth ? t("navbar.switch_to_hosting") : t("navbar.airbnb_your_home")}
              </button>
            </span>
            ...
            >
              ...
              {isLogin || (auth && userProfile?.user?.avatar) ? (
                <img
              ...
              <span
                className="position-absolute top-0 start-100 me-5 mt-1 translate-middle badge rounded-pill bg-danger"
                style={{ fontSize: "10px" }}
              >
                2
              </span>
  ...
  <ul className="list-unstyled mb-0 m-2">
    <li>
      <Link to="/messages" className="dropdown-item m-2" style={{ fontSize: "13px" }}>
        {t("navbar.messages")}
      </Link>
    </li>
    <li>
      <Link to="/trips" className="dropdown-item m-2" style={{ fontSize: "13px" }}>
        {t("navbar.trips")}
      </Link>
    </li>
    <li>
      <Link to="/wishlist" className="dropdown-item m-2" style={{ fontSize: "13px" }}>
        {t("navbar.wishlist")}
      </Link>
    </li>
    <div className="border"></div>
    <li>
      <Link to="/profile" className="dropdown-item m-2" style={{ fontSize: "13px" }}>
        {t("navbar.manage_listings")}
      </Link>
    </li>
    <li>
      <Link to="/bookings" className="dropdown-item m-2" style={{ fontSize: "13px" }}>
        {t("navbar.host_experience")}
      </Link>
    </li>
    <li>
      <Link to="/bookings" className="dropdown-item m-2" style={{ fontSize: "13px" }}>
    ...
    <li>
      <Link to="/Account" className="dropdown-item m-2" style={{ fontSize: "13px" }}>
        {t("navbar.account")}
      </Link>
    </li>
    <div className="border"></div>
    <li>
      <Link to="/settings" className="dropdown-item m-2" style={{ fontSize: "13px" }}>
        {t("navbar.gift_cards")}
      </Link>
    </li>
    <li>
      <Link to="/help" className="dropdown-item m-2" style={{ fontSize: "13px" }}>
        {t("navbar.help_center")}
      </Link>
    </li>
    <li>
      <Link className="dropdown-item m-2" onClick={handelLogout} style={{ fontSize: "13px" }}>
        {t("navbar.logout")}
      </Link>
    </li>
  </ul>
  ...
  !isLogin && (
    <ul className="list-unstyled mb-0 m-2">
      ...
      {!isScrolled && <SearchBar className="w-50" />}
      <ModalLogin />
    </>
  );
};
const SearchBar = () => {
  ...
  const destinations = [
    {
      name: "Hurghada, Egypt",
      reason: "Because your wishlist has stays in Tenerife",
      icon: <PiSwimmingPoolBold />,
    },
    {
      name: "Aspen, USA",
      reason: "For sights like Plaza de España",
      icon: <BsWater color="#81AFF1" />,
    },
    {
      name: "London, United Kingdom",
      reason: "Guests interested in Amsterdam also looked here",
      icon: <PiBuildingApartmentFill />,
    },
    {
      name: "Miami, USA",
      reason: "For its bustling nightlife",
      icon: <FaSwimmer color="#81AFF1" />,
    },
  ];
    ...
    <div className="d-flex shadow-sm pb-2 align-items-center justify-content-center  hmada">
      <div className="bg-white d-flex align-items-center search-bar position-relative hamad">
        <div className="search-section">
          <div className="search-label">{t("serach-Where")}</div>
          <input
            type="text"
            value={AddressValue}
            onClick={() => {
            ...
            className="border-0 search-input search-label "
        ...
        {showAddress && (
          <>
            ...
            >
              <label className="m-2" style={{ fontSize: "10px" }}>
                Recent searches
              </label>
              {destinations.map((destination, index) => {
                return (
                  <div key={index} className="mb-2">
                    <button
                      className="fw-bold text-start border-0 selectElement"
        ...
        <div className="search-section">
          <div className="search-label">{t("search.check_in")}</div>
          ...
          <DatePicker
            ...
            className="border-0 calenderNew"
             placeholderText={t("search.add_dates")}
          />
        </div>

        <div className="search-section">
          <div className="search-label">{t("search.check_out")}</div>
        ...
        <div
          className="search-section2 me-2 position-relative"
          onClick={() => {
        ...
        >
          ...
          <div className="search-label">{ t("Add-guests")}</div>
