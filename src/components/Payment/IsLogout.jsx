  ...
  const IsLogout = () => {
    ...
    const tax = 0.14; 
    const totalPriceFinal = totalPrice + totalPrice  * tax;
    const total= totalPriceFinal.toFixed(2) ;
      ...
      <>
        <PayPalScriptProvider options={{ "client-id": "AVpz0jD3i5fe0TQHfA9VoVJWzuQ2TORj4hqs4EynrpzihlimSnm1iWTr5EdfU2afBvqh6mGuB22oPH8a", currency: "USD" }}>
          <div className='container-fluid w-75'>
            ...
            <ModalLogin />
            <MoadelChangeValue startDate={startDate} endDate={endDate} _id={_id}
            adults={adults} pricePerNight={pricePerNight} total={total}
             BookingID={BookingID}
            showChangValue={showChangValue} setshowChangValue={setshowChangValue}/>
          </div>
