...
const cardsData = [
  {
    title: "Personal info",
    icon: <FaUser size={25} />,
    description: "Manage your name, email and phone.",
  ...
  },
  {
    ...
    description: "Set up payment methods and view payouts.",
    path: "/account/payments",
  },
  {
    title: "Taxes",
    icon: <FaFileInvoiceDollar size={25} />,
    description: "Manage your tax information and invoices.",
    path: "/account/taxes",
  },
  {
    title: "Notifications",
  ...
  },
  {
    ...
    description: "Control what you share and with whom.",
    path: "/account/privacy",
  },
  {
    title: "Global preferences",
    icon: <FaGlobe size={25} />,
    description: "Set your language, currency, and more.",
    path: "/account/global-preferences",
  },
  {
    title: "Travel for work",
    icon: <FaBriefcase size={25} />,
    description: "Organize business travel easily.",
    path: "/account/travel",
  },
  {
    title: "Professional hosting tools",
    icon: <FaTools size={25} />,
    description: "Enhance your hosting experience.",
    path: "/account/hosting-tools",
  },
  {
    title: "Guest referrals",
...
const UserInfo = () => {
  ...
  return (
    <div className=" m-5" style={{ marginTop: "100px", margin: "auto" }}>
      <h1>Account</h1>
      <div
        className="Account d-flex font-weight-bold font-size="
        style={{ fontSize: "20px" }}
      >
        <p>
          {userData.name
        ...
        {cardsData.map((card, index) => (
          <div className="col-12 col-sm-6 col-md-4" key={index}>
            <Link to={card.path} className="text-decoration-none">
              <div
                className="card text-center shadow  style-card"
